...
class Var(object):
    APP_ID = int(os.environ.get("APP_ID", 7819776))
    # 7819776 is a placeholder
    API_HASH = os.environ.get("API_HASH", "c1ba9e7e604ac58b57d01fa859cf5c15")
    ...
    SUDO_USERS = set(int(x) for x in os.environ.get("SUDO_USERS", "1885117298").split())
